...
df_electrones = pd.DataFrame({
    ...
    'quark_px_e': bquark_px_e,
    'quark_py_e': bquark_py_e,
    'quark_pz_e': bquark_pz_e,
    'quark_e_e': bquark_e_e,
    'anti_quark_px_e': anti_bquark_px_e,
    'anti_quark_py_e': anti_bquark_py_e,
    'anti_quark_pz_e': anti_bquark_pz_e,
    'anti_quark_e_e': anti_bquark_e_e
})
# Guardar como CSV
...
df_muones = pd.DataFrame({
    ...
    'quark_px_m': bquark_px_m,
    'quark_py_m': bquark_py_m,
    'quark_pz_m': bquark_pz_m,
    'quark_e_m': bquark_e_m,
    'anti_quark_px_m': anti_bquark_px_m,
    'anti_quark_py_m': anti_bquark_py_m,
    'anti_quark_pz_m': anti_bquark_pz_m,
    'anti_quark_e_m': anti_bquark_e_m
})
