...
# strage quark dataframe (electron channel)
df_electrones_s = pd.DataFrame({
    'electron_px': electron_px_bg_s,
    'electron_py': electron_py_bg_s,
    'electron_pz': electron_pz_bg_s,
    'electron_e': electron_e_bg_s,
    'positron_px': positron_px_bg_s,
    'positron_py': positron_py_bg_s,
    'positron_pz': positron_pz_bg_s,
    'positron_e': positron_e_bg_s,
    'quark_px': squark_px_e_bg,
    'quark_py': squark_py_e_bg,
    'quark_pz': squark_pz_e_bg,
    'quark_e': squark_e_e_bg,
    'anti_quark_px': anti_squark_px_e_bg,
    'anti_quark_py': anti_squark_py_e_bg,
    'anti_quark_pz': anti_squark_pz_e_bg,
    'anti_quark_e': anti_squark_e_e_bg,
    
})
# Guardar como CSV
df_electrones_s.to_csv('mc_s_gg2zg_electrons.csv', index=False) 

# strage quark dataframe (muon channel)
df_muones_s = pd.DataFrame({
    'muon_px': muon_px_bg_s,
    'muon_py': muon_py_bg_s,
    'muon_pz': muon_pz_bg_s,
    'muon_e': muon_e_bg_s,
    'antimuon_px': antimuon_px_bg_s,
    'antimuon_py': antimuon_py_bg_s,
    'antimuon_pz': antimuon_pz_bg_s,
    'antimuon_e': antimuon_e_bg_s,
    'quark_px': squark_px_m_bg,
    'quark_py': squark_py_m_bg,
    'quark_pz': squark_pz_m_bg,
    'quark_e': squark_e_m_bg,
    'anti_quark_px': anti_squark_px_m_bg,
    'anti_quark_py': anti_squark_py_m_bg,
    'anti_quark_pz': anti_squark_pz_m_bg,
    'anti_quark_e': anti_squark_e_m_bg,
    
})
# Guardar como CSV
df_muones_s.to_csv('mc_s_gg2zg_muons.csv', index=False) 

# charm quark dataframe (electron channel)
df_electrones_c = pd.DataFrame({
    'electron_px': electron_px_bg_c,
    'electron_py': electron_py_bg_c,
    'electron_pz': electron_pz_bg_c,
    'electron_e': electron_e_bg_c,
    'positron_px': positron_px_bg_c,
    'positron_py': positron_py_bg_c,
    'positron_pz': positron_pz_bg_c,
    'positron_e': positron_e_bg_c,
    'quark_px': cquark_px_e_bg,
    'quark_py': cquark_py_e_bg,
    'quark_pz': cquark_pz_e_bg,
    'quark_e': cquark_e_e_bg,
    'anti_quark_px': anti_cquark_px_e_bg,
    'anti_quark_py': anti_cquark_py_e_bg,
    'anti_quark_pz': anti_cquark_pz_e_bg,
    'anti_quark_e': anti_cquark_e_e_bg,
    
})
# Guardar como CSV
df_electrones_c.to_csv('mc_c_gg2zg_electrons.csv', index=False) 

# charm quark dataframe (muon channel)
df_muones_c = pd.DataFrame({
    'muon_px': muon_px_bg_c,
    'muon_py': muon_py_bg_c,
    'muon_pz': muon_pz_bg_c,
    'muon_e': muon_e_bg_c,
    'antimuon_px': antimuon_px_bg_c,
    'antimuon_py': antimuon_py_bg_c,
    'antimuon_pz': antimuon_pz_bg_c,
    'antimuon_e': antimuon_e_bg_c,
    'quark_px': cquark_px_m_bg,
    'quark_py': cquark_py_m_bg,
    'quark_pz': cquark_pz_m_bg,
    'quark_e': cquark_e_m_bg,
    'anti_quark_px': anti_cquark_px_m_bg,
    'anti_quark_py': anti_cquark_py_m_bg,
    'anti_quark_pz': anti_cquark_pz_m_bg,
    'anti_quark_e': anti_cquark_e_m_bg,
})
# Guardar como CSV
df_muones_c.to_csv('mc_c_gg2zg_muons.csv', index=False) 

# bottom quark dataframe (electron channel)
df_electrones_b = pd.DataFrame({
    'electron_px': electron_px_bg_b,
    'electron_py': electron_py_bg_b,
    'electron_pz': electron_pz_bg_b,
    'electron_e': electron_e_bg_b,
    'positron_px': positron_px_bg_b,
    'positron_py': positron_py_bg_b,
    'positron_pz': positron_pz_bg_b,
    'positron_e': positron_e_bg_b,
...
# Guardar como CSV
df_electrones_b.to_csv('mc_b_gg2zg_electrons.csv', index=False) 

# bottom quark dataframe (muon channel)
df_muones_b = pd.DataFrame({
    'muon_px': muon_px_bg_b,
    'muon_py': muon_py_bg_b,
    'muon_pz': muon_pz_bg_b,
    'muon_e': muon_e_bg_b,
    'antimuon_px': antimuon_px_bg_b,
    'antimuon_py': antimuon_py_bg_b,
    'antimuon_pz': antimuon_pz_bg_b,
    'antimuon_e': antimuon_e_bg_b,
...
# Guardar como CSV
df_muones_b.to_csv('mc_b_gg2zg_muons.csv', index=False)